    ...
    db.serialize(() => {
      ...
      db.get("SELECT COUNT(*) as count FROM categories", (err, row: { count: number }) => {
        ...
        const categories = [
          ...
          { id: 6, name: 'Flavoured Drinks', parent_id: 5, path: '/1/3/5/6', level: 3 },
        ...
        // Insert attributes
        const attributes = [
          { id: 1, name: 'Color', type: 'select', options: '["Red", "Blue", "Green", "Yellow", "Black", "White"]' },
          { id: 2, name: 'Flavour', type: 'select', options: '["Vanilla", "Chocolate", "Strawberry", "Orange", "Lemon"]' },
          { id: 3, name: 'Size', type: 'select', options: '["Small", "Medium", "Large", "Extra Large"]' },
          ...
          { id: 7, name: 'Temperature', type: 'select', options: '["Hot", "Cold", "Room Temperature"]' },
          { id: 8, name: 'Sweetness Level', type: 'select', options: '["No Sugar", "Low", "Medium", "High"]' },
        ];
