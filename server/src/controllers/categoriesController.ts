...
export const getCategoryTree = async (req: Request<object, object, object, CategoryTreeQuery>, res: Response) => {
  try {
    const {
      ...
      db.all(query, [], (err, rows: Array<{
        ...
        rows.forEach(row => {
          const node: CategoryTreeNode = {
            ...
            level: row.level,
            children: [],
            ...(includeAttributeCount && { attributeCount: row.attribute_count || 0 }),
